...
from backend.database.models import UserMemory, MeetingHistory
...
async def generate_embedding(text: str) -> list[float]:
    ...
    try:
        ...
        print(f"Ollama Embedding Error (Make sure Ollama is running and has {EMBEDDING_MODEL} installed): {e}")
